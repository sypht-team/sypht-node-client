 ...
 */
    ...
    async fileUpload(fieldSets, filePath){
        try{
            ...
            formData.append('products', JSON.stringify(fieldSets));
...
module.exports = new Sypht({apiKey : process.env.SYPHT_API_KEY, authEndpoint : process.env.SYPHT_AUTH_ENDPOINT, apiHost : process.env.SYPHT_API_HOST});
